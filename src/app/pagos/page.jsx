...
export default function Pagos() {
  ...
  const getPagos = async () => {
    try {
      ...
      // Invertir el orden de los pagos
  ...
  const formatFecha = (fechaString) => {
    ...
    return fecha.toLocaleDateString(); // Formato local de la fecha (ej. "02/10/2024")
  };
        ...
        <tbody>
          {pagos.map((pago, index) => (
            <tr key={index} className="hover:bg-gray-100">
              ...
              <td className="px-6 py-4 border-b border-gray-200 text-sm">{formatFecha(pago.fecha)}</td>
